...
public class NetworkUtils {
    ...
    private static final String PARAMS_MIN_COUNT = "vote_count.gte";

    private static final String API_KEY = "e3d93cc0cc45d191a302005db6d8c61e";
    ...
    public static URL buildURL(int sortBy, int page) {
        ...
        Uri uri = Uri.parse(BASE_URL).buildUpon()
                ...
                .appendQueryParameter(PARAMS_MIN_COUNT, MIN_VOTE_COUNT_VALUE)
